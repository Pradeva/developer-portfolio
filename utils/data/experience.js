export const experiences = [
  ...
  },
  {
    ...
    description1: "- Suicide prevention detection on the Jakarta Pedestrian Bridge.",
    description2: "- Developed a Video Management System website based on Node Js and React.",
  ...
  },
  {
    ...
    description1: "- Develop an IoT-integrated attendance data collection website.",
    description2: "- Develop a mobile application for data collection of fiber optic network additions.",
  ...
  },
  {
    ...
    description1: "- Development of an integrated office management mobile application with an automated attendance system using node.js, Express, and Flutter.",
    description2: "- Development of ticket sales and live stream event websites for concerts and online seminars using node.js, Express, Sequelize, and React Js.",
    description3: "- Development of a video management system for all camera brands using RTSP access with node.js, Express, and React Js."
  }
]